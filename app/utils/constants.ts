export const ProductsData = [
  {
    ...
    features: [
      {
        icon: "mars",
        header: "Pregnancy Tools",
        description:
          "Stay on top of your journey with tools like pregnancy notes, a due date calculator, baby movement counter, and a weight tracker. These features help you record important milestones and monitor your well-being throughout your pregnancy.",
      },
      {
        icon: "objects-column",
        header: "Medical Findings",
        description:
          "Access your medical results, track vital signs, and store ultrasound images securely in one place. Easily follow your pregnancy progress and review your health history at any time.",
      },
      {
        icon: "calendar",
        header: "Anamnesis Form",
        description:
          "Complete your medical history digitally from the comfort of your home. Share it instantly and securely with your healthcare provider to save time during consultations.",
      },
      {
        icon: "shield",
        header: "AREWA Guide",
        description:
          "Learn about essential nutrients and how to prepare for a healthy pregnancy. Get answers to common questions with our informative FAQ section.",
      },
      {
        icon: "lightbulb",
        header: "Period Tracker",
        description:
  ...
  },
  {
    ...
    features: [
      {
        icon: "crown",
        header: "Enlightenment & Counseling",
        description:
          "Keep a structured record of medical consultations, lifestyle habits, and behaviors such as nutrition, stress, and sleep. Receive tailored advice on career, sports, travel, and maternity protection, all in one unified overview.",
      },
      {
        icon: "map-marker",
        header: "Smart Appointment Overview",
        description:
          "View a chronological list of all important dates and appointments at a glance. Get timely reminders for emergencies, complications, or medications, and manage patient data and scheduling with ease.",
      },
      {
        icon: "chart-bar",
        header: "Gravida Chart",
        description:
          "Access a centralized view of all pregnancy check-ups and examination details. Track vital parameters like SSW, blood pressure, and weight in a clear, timeline-based format for both doctors and patients.",
      },
      {
        icon: "heart",
        header: "Labor Examinations",
        description:
          "Digitally record and store blood and infection test results with real-time updates. Keep important data such as blood type, Rh factor, and antibody status organized for quick reference.",
      },
      {
        icon: "question",
        header: "Pregnancy Risks",
        description:
